...
<br /> 
<img src="https://github.com/chloecode86/Deep-Learning_Stock-Prediction/blob/main/image/Heatmap.png" width="400" height="350"> <br /> 
<br /> 
#### Models Building
...
<br />  search_space = {"lstm_size":     np.linspace(50, 200, 5, dtype = int), <br />
<br />                "dropout":       np.linspace(0, 0.4, 2), <br />
<br />                "learning_rate": np.linspace(0.004, 0.01, 4)} <br />
